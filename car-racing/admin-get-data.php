...
$str .= "<div id='score' style='position: absolute; top: 10px; left: $lt; font-size: 20px; font-weight: bold;'>
...
if($on != '') {
	$on = substr($on, 0, -1); 
	$str .= "<div style='font-size: 16px; font-weight: bold; $pos width: 500px; background-color: #ddd;'>
				User online are: 
